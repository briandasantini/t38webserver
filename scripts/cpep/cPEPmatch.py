#!/home/web_service/miniconda3/envs/webserver/bin/python
# # cPEPmatch
...
def main(args):
    ...
    #print_and_log(update_progress(0.25))
    ...
    #print_and_log(update_progress(0.5))
    update_progress(0.5)
    print("\nStep 2 complete.\n")
    ...
    all_match.sort()
    #print_and_log(update_progress(0.75))
    ...
    #print_and_log(update_progress(1.0))
    update_progress(1.0)
    ...
    print("\n \nYour results are now available for 30 days\n")
...
if __name__ == "__main__":
    ...
    default_test_system_location = os.getcwd()
